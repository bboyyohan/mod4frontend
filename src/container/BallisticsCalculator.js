        ...
        return(
            <div> 
                <form onSubmit={this.handleSubmit}> 
                    ...
                    <label>Weight:
                        <br/>
                        <input class="form-control" placeholder='Weight' name='bulletWeight' type="number" set="any" onChange={this.changeHandler} value={this.state.bulletWeight}/>
                    </label>
                    <br/>
                    </div>
                    ...
                    <label>Muzzle Velocity:
                        <br/>
                        <input class="form-control" placeholder='Muzzle Velocity' name='muzzleVelocity' type="number" set="any" onChange={this.changeHandler} value={this.state.muzzleVelocity}/>
                    </label>
                    <br/>
                    </div>
                    {this.state.calibre 
                    ...
                    <div>
                        ...
                        <div class="form-group mx-sm-3 mb-2">
                            <label>Barrel Length:
                        <br/>
                        <input class="form-control" placeholder='Barrel Length' name='barrelLength' type="number" set="any" onChange={this.changeHandler} value={this.state.barrelLength}/>
                        </label>
                        </div>
                    </div>
                    :
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <label>Drag Coefficient:
                            <br/>
                            <input class= "form-control" placeholder='Drag Coefficient' name='dragCoefficient' type="number" set="any" onChange={this.changeHandler} value={this.state.dragCoefficient}/>
                        </label>
                    </div>
                    ...
                    <div className="form-check">
                        <label>Wind:
                            <br/>
                            <input class= "form-control" placeholder='Wind mph' name='windMPH' type="number" set="any" onChange={this.changeHandler} value={this.state.windMPH}/>
                            <br/>
                            <input class= "form-control" placeholder='Wind m/s' name='windMPS' type="number" set="any" onChange={this.changeHandler} value={this.state.windMPS}/>
                            <br/>
                            <label> left </label>
                            <br/>
                            <input name='windLeft' type="radio" className="form-check-input" value="option1" checked={this.state.selectedOption === "option1"}
                        ...
                        <label>Temp:
                            <br/>
                                <input class= "form-control" placeholder='Temperature in Fahrenheit' name='temp' type="number" set="any" onChange={this.changeHandler} value={this.state.temp}/>
                            <br/>
                        </label>
                        <br/>
                        <label>Dew Point:
                            <br/>
                                <input class= "form-control" placeholder='Dew Point Temperature in Fahrenheit' name='dewPoint' type="number" set="any" onChange={this.changeHandler} value={this.state.dewPoint}/>
                            <br/>
                        </label>
                        <br/>
                        <label>Initial Height:
                            <br/>
                                <input class= "form-control" placeholder='Initial Height' name='initialHeight' type="number" set="any" onChange={this.changeHandler} value={this.state.initialHeight}/>
                            <br/>
                        </label>
                        <br/>
                        <label>Altitude:
                            <br/>
                                <input class= "form-control" placeholder='Altitude' name='altitude' type="number" set="any" onChange={this.changeHandler} value={this.state.altitude}/>
                            <br/>
                        </label>
                    </div>
                    ...
                    <label> Shooting Angle: </label>
                    <br/>
                        <input class= "form-control" placeholder='Shooting Angle' name='shootingAngle' type="number" set="any" onChange={this.changeHandler} value={this.state.shootingAngle}/>
                    <br/>
                    </div>
